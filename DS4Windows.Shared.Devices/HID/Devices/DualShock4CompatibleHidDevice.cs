...
using DS4Windows.Shared.Devices.Legacy;
...
namespace DS4Windows.Shared.Devices.HID.Devices
{
    public class DualShock4CompatibleHidDevice : CompatibleHidDevice
    {
        ...
        {
            runCalib = (featureSet & CompatibleHidDeviceFeatureSet.NoGyroCalib) == 0;
        ...
        public delegate void ReportHandler<TEventArgs>(DualShock4CompatibleHidDevice sender, TEventArgs args);
        ...
        public virtual event Action<DualShock4CompatibleHidDevice> BatteryChanged;
        ...
        public virtual event Action<DualShock4CompatibleHidDevice> ChargingChanged;
        ...
        public static ConnectionType HidConnectionType(ICompatibleHidDevice hidDevice)
        {
        ...
        public virtual void PostInit()
        {
            ...
            if (Connection is ConnectionType.Usb or ConnectionType.SonyWirelessAdapter)
            {
                ...
                outputReport = new byte[Capabilities.OutputReportByteLength];
                outReportBuffer = new byte[Capabilities.OutputReportByteLength];
                ...
                Connection                {
                    ...
                    {
                        audio = new DS4Audio(searchDeviceInstance: ParentPath);
                    ...
                    else if (FeatureSet.HasFlag(CompatibleHidDeviceFeatureSet.MonitorAudio))
                    {
                        audio = new DS4Audio(searchDeviceInstance: ParentPath);
                        micAudio = new DS4Audio(DataFlow.Capture,
                            ParentPath);
            ...
            else
            {
                ...
                if ((FeatureSet & CompatibleHidDeviceFeatureSet.OnlyOutputData0x05) == 0)
                {
                ...
                else
                {
                    ...
                    outputReport = new byte[Capabilities.OutputReportByteLength <= 15
                        ? 15
                        : Capabilities.OutputReportByteLength];
                    outReportBuffer = new byte[Capabilities.OutputReportByteLength <= 15
                        ? 15
                        : Capabilities.OutputReportByteLength];
                }
            ...
            if (Connection == ConnectionType.Bluetooth &&
                !FeatureSet.HasFlag(CompatibleHidDeviceFeatureSet.NoOutputData) &&
                !FeatureSet.HasFlag(CompatibleHidDeviceFeatureSet.OnlyOutputData0x05))
        ...
        private void CheckOutputReportTypes()
        {
            ...
            if (finalReport == 0x00) ModifyFeatureSetFlag(CompatibleHidDeviceFeatureSet.NoOutputData, true);
        }
        ...
        public virtual void RefreshCalibration()
        {
            ...
            calibration[0] = Connection == ConnectionType.Bluetooth ? (byte)0x05 : (byte)0x02;
            ...
            if (Connection == ConnectionType.Bluetooth)
            {
                ...
                sixAxis.SetCalibrationData(ref calibration, Connection == ConnectionType.Usb);

                if (Attributes.ProductId == 0x5C4 && Attributes.VendorId == 0x054C &&
            ...
            if (ds4Input == null)
            {
                if (Connection == ConnectionType.Bluetooth)
                {
                    if (BluetoothOutputMethod == BluetoothOutputReportMethod.HidD_SetOutputReport)
                    {
                        ...
                        ds4Output.Name = "DS4 Output thread: " + Serial;
                    ...
                    timeoutCheckThread.Name = "DS4 Timeout thread: " + Serial;
                ...
                else
                {
                    ...
                    ds4Output.Priority = ThreadPriority.Normal;
                    ds4Output.Name = "DS4 Arr Copy thread: " + Serial;
                    ds4Output.IsBackground = true;
                    ds4Output.Start();
                }
                ...
                ds4Input.Name = "DS4 Input thread: " + Serial;
                ds4Input.IsBackground = true;
                //ds4Input.Start();
            }
            else
            {
                Debug.WriteLine("Thread already running for DS4: " + Serial);
            }
        }
        ...
        protected bool WriteOutput(byte[] outputBuffer)
        {
            if (Connection == ConnectionType.Bluetooth)
            {
                ...
                if (BluetoothOutputMethod == BluetoothOutputReportMethod.WriteFile)
                    ...
                    return WriteOutputReportViaInterrupt(outputBuffer, READ_STREAM_TIMEOUT);
                return WriteOutputReportViaControl(outputBuffer);
            }
        ...
        protected bool WriteOutput()
        {
            if (Connection == ConnectionType.Bluetooth)
                ...
                return BluetoothOutputMethod == BluetoothOutputReportMethod.WriteFile
                    ...
                    : WriteOutputReportViaControl(outputReport);

            return WriteOutputReportViaInterrupt(outReportBuffer, READ_STREAM_TIMEOUT);
        }
                ...
                while (!exitOutputThread)
                {
                    if (currentRumble)
                    {
                        ...
                        if (!result)
                        {
                            ...
                            {
                                Console.WriteLine(Serial + " " + DateTime.UtcNow.ToString("o") +
        ...
        protected unsafe void PerformDs4Input()
        {
            unchecked
            {
                ...
                idleInput = true;
                var syncWriteReport = Connection != ConnectionType.Bluetooth ||
                ...
                while (!exitInputThread)
                {
                    ...
                    if (Connection == ConnectionType.Bluetooth &&
                        (FeatureSet & CompatibleHidDeviceFeatureSet.OnlyInputData0x01) == 0)
                    {
                        ...
                        res = ReadInputReport(InputReportBuffer, btInputReport.Length, out _);
                    ...
                    else
                    {
                        ...
                        var res = ReadInputReport(InputReportBuffer, inputReport.Length, out _);
                    ...
                    if (Connection == ConnectionType.Bluetooth && btInputReport[0] != 0x11 &&
                        (FeatureSet & CompatibleHidDeviceFeatureSet.OnlyInputData0x01) == 0)
                    ...
                    if ((FeatureSet & CompatibleHidDeviceFeatureSet.NoBatteryReading) == 0)
                    {
                    ...
                    */
                    ...
                    else
                    {
                        ...
                        if (shouldDisconnect)
                        {
                            ...
                            else if (Connection == ConnectionType.SonyWirelessAdapter)
                            {
                                DisconnectDongle();
                            }
                        }
        ...
        {
            var usingBT = Connection == ConnectionType.Bluetooth;

            if (usingBT && (FeatureSet & CompatibleHidDeviceFeatureSet.OnlyOutputData0x05) == 0)
            {
        ...
        private void SendOutputReport(bool synchronous, bool force = false, bool quitOutputThreadOnError = true)
        {
            ...
            if ((FeatureSet & CompatibleHidDeviceFeatureSet.NoOutputData) != 0)
            {
        ...
        public virtual bool DisconnectWireless(bool callRemoval = false)
        {
            ...
            else if (Connection == ConnectionType.SonyWirelessAdapter) result = DisconnectDongle(callRemoval);
        ...
        public virtual bool DisconnectBT(bool callRemoval = false)
        {
            if (Serial != null)
            {
                ...
                StopOutputUpdate();
                Console.WriteLine("Trying to disconnect BT device " + Serial);
                ...
                // 
                var sbytes = Serial.ToFriendlyName().Split(':');
                for (var i = 0; i < 6; i++)
        ...
        public virtual bool DisconnectDongle(bool remove = false)
        {
            ...
            lock (outputReport)
            {
                result = WriteFeatureReport(disconnectReport);
            }
        ...
        public void UpdateSerial()
        {
            ...
            var tempMac = ReadSerial(SerialReportID);

            if (tempMac.Equals(Serial)) return;
        ...
        {
            return !Serial.Equals(PhysicalAddress.Parse(BLANK_SERIAL));
        }
